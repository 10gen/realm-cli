...
func TestRealmDrafts(t *testing.T) {
	...
	t.Run("With an active session", func(t *testing.T) {
		...
		t.Run("Getting drafts should fail if there are none", func(t *testing.T) {
			_, err := client.Draft(groupID, testApp.ID)

		...
		},
		{
			...
			expectedContent: strings.Join(
				[]string{
					...
					"  ---------------  ------  ------  -------  ------------",
					"  user-1@test.com  user-1  type-1  yes      client error",
					"",
				},
				"\n",
			),
		},
		{
			...
			expectedContent: strings.Join(
				[]string{
					...
					"  Email            ID      Type    Enabled  Details     ",
					"  ---------------  ------  ------  -------  ------------",
					"  user-2@test.com  user-2  type-2  yes      client error",
					"  user-1@test.com  user-1  type-1  no                   ",
					"  user-3@test.com  user-3  type-1  no                   ",
					"01:23:45 UTC INFO  Provider type: ApiKey",
					"  Name    ID      Type    Enabled  Details     ",
					"  ------  ------  ------  -------  ------------",
					"  name-4  user-4  type-1  yes      client error",

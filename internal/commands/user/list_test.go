		...
		},
		{
			...
			expectedContent: strings.Join(
				[]string{
					...
					"  --------  ---  -----  -------  -----------------------------",
					"  myEmail2  id2  type2  yes      2005-03-20 15:42:13 +0000 UTC",
					"  myEmail3  id3  type1  yes      2005-03-19 08:50:22 +0000 UTC",
					"  myEmail1  id1  type1  yes      2005-03-18 01:58:31 +0000 UTC",
					"01:23:45 UTC INFO  Provider type: ApiKey",
					"  Name    ID   Type   Enabled  Last Authenticated           ",
					"  ------  ---  -----  -------  -----------------------------",
					"  myName  id4  type1  yes      2005-03-18 01:58:31 +0000 UTC",
					"",
				},
				"\n",
			),
